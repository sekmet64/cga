...
// brass
Material cg::MatFBBrass = Material(
...
// emerald
Material cg::MatFBEmerald = Material(
...
// gold
Material cg::MatFBGold = Material(
...
// pearl
Material cg::MatFBPearl = Material(
...
// ruby
Material cg::MatFBRuby = Material(
...
// silver
Material cg::MatFBSilver = Material(
...
// turquoise
Material cg::MatFBTurquoise = Material(
